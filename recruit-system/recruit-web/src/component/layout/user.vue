  ...
  <div class="user">
    <el-dropdown>
      <span class="el-dropdown-link">
        <div class="nav-avatar" v-if="userImg"><img :src="userImg || defaultAvatar" alt="头像" /></div>
      </span>
      <el-dropdown-menu slot="dropdown" class="user-box">
        <div class="user-info">
          <div class="avatar" title="点击修改头像" v-if="userImg">
            <img :src="userImg || defaultAvatar" alt="头像" />
            <label class="mask">
    ...
    <el-dialog title="修改密码" :append-to-body="true" :before-close="handleClose" :visible.sync="dialogFormVisible"
      class="user-dialog">
  ...
  methods: {
    ...
    async handleCrop() {
      ...
      return this.$axios({
        ...
        // }
        console.log("得到的结果是啥",res[0].path);
        return this.$axios({
          method: 'put',
          url: '/recruit/user',
          data: {
    ...
    init() {
      ...
      // 设置头像
      this.userImg = user.avatar ? user.avatar : this.defaultAvatar;
    },
    goToCenter() {
